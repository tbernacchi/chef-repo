...
%w{ api-transacional agendamento-pagamento-tif dfin infra-noc infra-virtualizacao mis sustentacao street cip fornecedores pre-pago relatorios }.each do |projects|
  execute "#{projects}" do
